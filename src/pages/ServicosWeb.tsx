...
export default function ServicosWeb() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <Helmet>
        <title>Serviços Web | Multitel</title>
        <meta name="description" content="Desenvolvimento de sites, portais, sistemas, SEO, performance, responsividade e segurança para sua empresa." />
      </Helmet>
      {/* Hero Section */}
      <div className="relative bg-blue-600 text-white py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold mb-6 text-white">{t('navbar.servicos_web')}</h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">{t('navbar.servicos_web_desc')}</p>
          </div>
        </div>
      </div>
      {/* Features */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Desenvolvimento Personalizado</h3>
              <p className="text-gray-600">Sites, portais e sistemas sob medida</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Optimização para resultados e velocidade</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Smartphone className="w-8 h-8 text-blue-600" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Responsividade</h3>
              <p className="text-gray-600">Experiência perfeita em qualquer dispositivo</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Protecção de dados e hospedagem segura</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8">Solicite uma Proposta de Serviços Web</h2>
